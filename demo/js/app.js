...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (createClassBtn) {
        createClassBtn.addEventListener('click', () => openModal('modal-create-class'));
    }
    ...
    if (punchBtn) {
        ...
        punchBtn.addEventListener('click', () => {
            ...
            if (isPunchedIn) {
                ...
                // Show toast
                showToast("Punch Successful", "You punched in for CSE 210 at " + new Date().toLocaleTimeString(), "success");
            } else {
                // Punch Out State
    ...
    if (searchTrigger) {
        searchTrigger.addEventListener('click', () => {
            showToast('Coming Soon', 'Spotlight Search (Cmd+K) is under construction', 'info');
        });
    }
});
